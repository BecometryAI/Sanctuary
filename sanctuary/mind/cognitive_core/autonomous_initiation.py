"""
Autonomous Initiation: Proactive speech capability for the system.
...
the system's development as self-awareness must be externalized and grounded through dialogue.
...
the system's meta-cognition is externalized and validated through human interaction,
...
class AutonomousInitiationController:
    ...
    def _check_introspection_trigger(self, snapshot: WorkspaceSnapshot) -> Optional[Goal]:
        ...
        Meta-cognition in a vacuum leads to solipsism—the system must externalize
    ...
    def _check_value_conflict_trigger(self, snapshot: WorkspaceSnapshot) -> Optional[Goal]:
        ...
        When the system detects conflicts between its charter values and recent actions
    ...
    def _check_emotional_trigger(self, snapshot: WorkspaceSnapshot) -> Optional[Goal]:
        ...
        the system stay grounded and provides transparency about its internal state.
    ...
    def _should_rate_limit(self) -> bool:
        ...
        between autonomous initiations. This ensures the system doesn't spam but can
