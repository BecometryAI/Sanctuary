...
This module implements the IdentityLoader class, which loads and manages the system's
...
class CharterDocument:
    ...
    The charter contains the system's core values, purpose statement, and behavioral
...
class IdentityLoader:
    """
    Loads and manages the system's identity documents.
    ...
    def _create_default_charter(self) -> CharterDocument:
        ...
        """
        return CharterDocument(
            full_text="I am a cognitive AI system.",
