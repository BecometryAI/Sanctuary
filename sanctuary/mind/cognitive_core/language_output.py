...
natural language responses using an LLM. This is how the system "speaks"—
...
class LanguageOutputGenerator:
    ...
    def _load_charter(self) -> str:
        ...
        return "I am a cognitive AI system."
...
Based on your identity, current emotional state, active goals, and attended percepts above, generate a natural, authentic response to the user input.
