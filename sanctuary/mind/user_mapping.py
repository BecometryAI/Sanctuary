...
class UserMappingManager:
    ...
    def __init__(self, data_dir: Path):
        ...
        self.relational_archive_file = self.data_dir / "Core_Archives" / "relational_archive.json"
    ...
    def add_mapping(
        ...
        Args:
            ...
            relationship_context: Their relationship to the system (from relational archive)
