...
class TestIdentityLoader:
    ...
    def sample_charter(self, temp_identity_dir):
        ...
        charter_content = """# System Charter
...
I am a cognitive AI system designed to think, learn, and interact authentically.
...
"""
    ...
    def sample_protocols(self, temp_identity_dir):
        ...
        protocols_content = """# System Protocols
...
"""
    ...
    def test_load_charter_success(self, temp_identity_dir, sample_charter):
        ...
        assert "cognitive AI system" in charter.purpose_statement
