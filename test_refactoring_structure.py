...
def test_file_existence():
    ...
    core_path = 'emergence_core/sanctuary/cognitive_core/core'
...
def test_legacy_file_moved():
    ...
    old_path = 'emergence_core/sanctuary/cognitive_core/core.py'
    legacy_path = 'emergence_core/sanctuary/cognitive_core/core_legacy.py'
